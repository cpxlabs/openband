---
name: clean-code-ddd-agent
description: Clean code and domain-driven architecture review agent — enforces SOLID, factory patterns, no `any`, explicit types, separation of concerns (project)
---
